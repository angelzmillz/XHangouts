...
public final class UiButtons {
    ...
    public static void handleLoadPackage(final Config config, ClassLoader loader) {
        ...
        findAndHookMethod(cGalleryPicker, "a", cFirstParam, cSecondParam, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        findAndHookMethod(cCameraPicker, "a", cFirstParam, cSecondParam, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        findAndHookMethod(cVideoPicker, "a", cFirstParam, cSecondParam, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        findAndHookMethod(cStickerPicker, "a", cFirstParam, cSecondParam, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
        ...
        findAndHookMethod(cLocationPicker, "a", cFirstParam, cSecondParam, new XC_MethodHook() {
            @Override
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
